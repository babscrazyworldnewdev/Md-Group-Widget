 ...
 */
export const trackVisitor = async (visitorTrackInput: VisitorTrackInput, options?: RequestInit): Promise<VisitorSession> => {

  return customFetch<VisitorSession>(getTrackVisitorUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getTrackVisitorMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof trackVisitor>>, TError,{data: BodyType<VisitorTrackInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof trackVisitor>>, TError,{data: BodyType<VisitorTrackInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof trackVisitor>>, {data: BodyType<VisitorTrackInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type TrackVisitorMutationBody = BodyType<VisitorTrackInput>
...
export const useTrackVisitor = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof trackVisitor>>, TError,{data: BodyType<VisitorTrackInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {data: BodyType<VisitorTrackInput>},
        TContext
      > => {
      return useMutation(getTrackVisitorMutationOptions(options));
    }

export const getListVisitorSessionsUrl = () => {
 ...
 */
export const listVisitorSessions = async ( options?: RequestInit): Promise<VisitorSession[]> => {

  return customFetch<VisitorSession[]>(getListVisitorSessionsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getListVisitorSessionsQueryKey = () => {
    return [
...
export const getListVisitorSessionsQueryOptions = <TData = Awaited<ReturnType<typeof listVisitorSessions>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listVisitorSessions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListVisitorSessionsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listVisitorSessions>>> = ({ signal }) => listVisitorSessions({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listVisitorSessions>>, TError, TData> & { queryKey: QueryKey }
}

export type ListVisitorSessionsQueryResult = NonNullable<Awaited<ReturnType<typeof listVisitorSessions>>>
export type ListVisitorSessionsQueryError = ErrorType<unknown>
...
export function useListVisitorSessions<TData = Awaited<ReturnType<typeof listVisitorSessions>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listVisitorSessions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListVisitorSessionsQueryOptions(options)
